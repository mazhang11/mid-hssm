...
# --- NEW FIX FOR LOCK ERRORS ---
export PYTENSOR_FLAGS="base_compiledir=/tmp/mazhang_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}"
mkdir -p /tmp/mazhang_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}
# -------------------------------
